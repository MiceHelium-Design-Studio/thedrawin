...
-- Ensure the buckets exist (run these if buckets don't exist)
...
-- INSERT INTO storage.buckets (id, name, public) VALUES ('draw_images', 'draw_images', true) ON CONFLICT DO NOTHING;
