        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div className="space-y-2">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-[#06B6D4]/20 rounded-lg flex items-center justify-center gold-pulse border border-[#06B6D4]/30">
                <div className="w-4 h-4 bg-[#06B6D4] rounded-sm shadow-lg" />
              </div>
              <h2 className="text-2xl font-bold text-white uppercase tracking-wide">
                <span className="bg-gradient-to-r from-[#06B6D4] to-[#F39C0A] bg-clip-text text-transparent">
                  ALL DRAWS
                </span>
              </h2>
            </div>
            ...
            <div className="text-center py-16 luxury-card relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <Button 
                  ...
                  className="premium-outline-button group mt-6"
                >
