        ...
        <div className="text-center py-16 luxury-card relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl font-bold text-white">No Winners Yet</h2>
              <p className="text-slate-400 max-w-md mx-auto leading-relaxed">
                The first draw results will be announced soon. Stay tuned for exciting winners!
              </p>
            </div>
          </div>
        </div>
              ...
              <CardContent className="p-8">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
                  <div className="text-center sm:text-left">
                    <p className="text-sm text-slate-400 mb-2 uppercase tracking-wide font-medium">Winner</p>
